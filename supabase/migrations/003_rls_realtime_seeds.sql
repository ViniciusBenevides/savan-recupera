...
('asaas', '{"ambiente":"sandbox","wallet_savan":"","comissao_pct":10}', 'Asaas: ambiente (sandbox|producao), walletId do credor para o split, % de comissão do operador'),
('chatwoot', '{"url":"https://chatwoot.example.com","account_id":1,"conversa_gestor_id":null}', 'Chatwoot: URL, conta e conversa do gestor para alertas'),
...
('Abordagem 1 — boa notícia', 'abordagem_inicial',
 '{Oi|Olá}, tudo {bem|certo}? Falo com {{primeiro_nome}}? Aqui é a {{nome_bot}}, da central de atendimento da nossa loja de calçados. {Tenho uma boa notícia em seu nome|Apareceu uma condição especial em seu nome aqui no sistema} e queria te contar rapidinho. Pode falar agora?', 3),
('Abordagem 2 — oportunidade', 'abordagem_inicial',
 '{Olá|Oi}! Sou a {{nome_bot}} e falo em nome da nossa loja de calçados 😊 Estou procurando {{primeiro_nome}} para uma oportunidade de regularização com desconto especial. {É você?|Falo com a pessoa certa?}', 3),
('Abordagem 3 — direta e leve', 'abordagem_inicial',
 '{Oi|Olá}, {{primeiro_nome}}! Aqui é a {{nome_bot}}, da nossa loja de calçados. Temos uma proposta exclusiva de encerramento definitivo de uma pendência antiga, com desconto de verdade. {Quer saber os detalhes?|Posso te explicar?}', 2),
('Follow-up 1 — lembrete leve', 'followup_1',
 '{Oi|Olá} {{primeiro_nome}}, {{nome_bot}} aqui de novo 😊 {Conseguiu ver minha mensagem?|Viu minha mensagem anterior?} A condição especial da loja ainda está disponível. {Posso te explicar rapidinho?|Quer aproveitar?}', 1),
('Follow-up 2 — validade', 'followup_2',
 '{{primeiro_nome}}, a proposta de quitação com desconto especial da loja está {nos últimos dias de validade|quase expirando}. Se quiser aproveitar, é só responder esta mensagem 🙏', 1),
...
('Proposta padrão', 'proposta',
 'Encontrei aqui: existe uma pendência antiga com a nossa loja de calçados, de {{ano_divida}}, no valor atualizado de R$ {{valor_original}}. A boa notícia: consigo te oferecer a quitação definitiva por apenas R$ {{valor_final}} ({{desconto_pct}}% de desconto), válida até {{valido_ate}}. Pagando, você recebe o termo de quitação na hora. Quer aproveitar?', 1),
('Envio de Pix', 'pix',
...
('Confirmação de pagamento', 'confirmacao_pagamento',
 'Pagamento confirmado! ✅ R$ {{valor_pago}} recebido. Sua pendência com a nossa loja de calçados está QUITADA — nada mais a pagar referente a este débito. Segue abaixo seu termo de quitação. Obrigada, {{primeiro_nome}}! 💚', 1),
('Termo de quitação', 'quitacao',
 '📄 *TERMO DE QUITAÇÃO*

A empresa credora declara, para os devidos fins, que *{{nome}}*, CPF {{cpf}}, quitou integralmente em {{data_pagamento}} a pendência registrada sob o processo {{processo}}, no valor negociado de R$ {{valor_pago}}, nada mais havendo a cobrar referente a este débito.
