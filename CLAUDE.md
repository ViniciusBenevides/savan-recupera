...
`Para Meta/WhatsApp, leia também o §38 de contexto-projeto.md: pode reatribuir o chip, registrar o número banido e criar ativos para ocultar ou evadir o bloqueio permanente.`

Mantenha estas regras materialmente idênticas às de `AGENTS.md`.
